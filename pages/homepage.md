...
Chez **NOVA Santé Intégrée**, nous favorisons une lecture plus large de chaque situation, en tenant compte du corps, du vécu, du rythme de vie et des besoins spécifiques de la personne.
...
Lorsque cela fait sens, les échanges entre thérapeutes permettent de construire un suivi plus cohérent et plus fluide.
...
- les **adultes**
- les **familles**
- les personnes vivant une période de transition, d’inconfort ou de réajustement
...
![Portraits ou illustration de l’équipe](https://placehold.co/600x400?text=Equipe)
...
➡️ Découvrir les thérapeutes actuellement au centre
